...
namespace FinalProject.Controllers
{
        ...
        public class AccountController : Controller
        {
            ...
            public IActionResult Index()
            {
                ...
                // ADDED (DATETIME)
                ivm.DateofBirth = (DateTime)user.DateofBirth;
            ...
            public IActionResult Edit()
            {
                ...
                var userEdit = new AccountEditViewModel
                {
                    //ADDED DATETIME 
                    DateOfBirth = (DateTime)currentUser.DateofBirth,
            ...
            {
                // OMITTED MODELSTATE.ISVALID

                AppUser userLoggedIn = await _userManager.FindByNameAsync(User.Identity.Name);

                if (userLoggedIn != null)
                {
                    userLoggedIn.DateofBirth = model.DateOfBirth;
                    userLoggedIn.Street = model.Street;
                    userLoggedIn.City = model.City;
                    userLoggedIn.State = model.State;
                    userLoggedIn.Zip = model.Zip;
                    userLoggedIn.PhoneNumber = model.PhoneNumber;

                    await _userManager.UpdateAsync(userLoggedIn);
